...
var (
	cli client.Client
	lastNetIOStatTimeStamp int64 //上一次获取网络IO 数据的时间点
...
func getDiskInfo()  {
	var diskInfo=&DiskInfo{
		PartitonUsageStat: make(map[string]*disk.UsageStat,16),
	}
	...
	for _,part:=range parts{
		...
		diskInfo.PartitonUsageStat[part.Mountpoint]=usageStat
	}
